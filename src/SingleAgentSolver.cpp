...
void SingleAgentSolver::invalidateHeuristic(){
	std::fill(my_heuristic.begin(), my_heuristic.end(), std::numeric_limits<int>::max());
}

void SingleAgentSolver::setGoalLocation(int new_goal)
{
	// change the planner's goal, and re-compute the heuristic
	if (goal_location != new_goal)
	{
