...
class Configuration(object):
    ...
    def init_defaults(self, args = None):
        self._values = {
                        ...
                        ('color', 'color_fetch0'): ConfigEntry(self._read_hex_from_config, 0xff0000, hex, 'color fetch 1'),
                        ('color', 'color_fetch1'): ConfigEntry(self._read_hex_from_config, 0xff0000, hex, 'color fetch 2'),
                        ('color', 'color_drive0'): ConfigEntry(self._read_hex_from_config, 0x00ff00, hex, 'color drive 1'),
                        ('color', 'color_drive1'): ConfigEntry(self._read_hex_from_config, 0x00ff00, hex, 'color drive 2'),
