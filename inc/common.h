...
enum CostType { SOC, MKSP };

typedef std::tuple<int, int, int, int, int> Meeting; // <location, time, agentA, agentB, cost>
typedef std::tuple<int, int, int, int, int, int> Task; // <task_start, task_goal, agentA_idx, agentA_start, agentB_idx, agentB_start> 
typedef std::tuple<int, int, int> Assignment; // <task_idx, agentA_idx, agentB_idx>
